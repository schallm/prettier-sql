...
from
    Books
    inner join freetexttable(Books, *, 'programming', 10) as ft on Books.Id = ft.[key];
```
...
values ('The Pragmatic Programmer: From Journeyman to Master', 1, 2, 39.99, 1, '2019-09-23');
```
