...
describe('options', () => {
    ...
    it('INSERT VALUES: single-column rows fill-pack in compact', async () => {
        // Single-column rows pack as many per line as fit within printWidth.
        const sql = `insert into @moviesToAdd (Id) values (310000267), (310000488), (310000577), (310000552), (310000399), (310000576), (310001689), (310000376), (310000623), (310000017)`;
        expect(await fmt(sql, { sqlDensity: 'compact' })).toMatchSnapshot();
    });

    it('INSERT VALUES: multi-column rows fill-pack in compact', async () => {
        // Multi-column rows also fill-pack in compact density.
        const sql = `insert into Books (Title, AuthorId, Price) values ('The Great Gatsby', 1, 9.99), ('To Kill a Mockingbird', 2, 12.99), ('Of Mice and Men', 3, 7.99), ('The Catcher in the Rye', 4, 11.99)`;
        expect(await fmt(sql, { sqlDensity: 'compact' })).toMatchSnapshot();
    });

    it('INSERT VALUES: multi-column rows one-per-line in spacious', async () => {
        const sql = `insert into Books (Title, AuthorId, Price) values ('The Great Gatsby', 1, 9.99), ('To Kill a Mockingbird', 2, 12.99), ('Of Mice and Men', 3, 7.99)`;
        expect(await fmt(sql, { sqlDensity: 'spacious' })).toMatchSnapshot();
    });
